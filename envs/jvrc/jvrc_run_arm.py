...
from tasks import running_arm_task  # 行走任务定义，包含奖励函数和终止条件
...
class JvrcRunArmEnv(mujoco_env.MujocoEnv):
    ...
    def __init__(self):
        ...
        # MuJoCo模型文件路径
        path_to_xml_out = '/tmp/mjcf-export/jvrc_run_arm/jvrc1.xml'
        ...
        # 设置行走任务
        self.task = running_arm_task.RunningArmTask(
        ...
        self.task._total_duration = 0.25  # 总步态周期持续时间
